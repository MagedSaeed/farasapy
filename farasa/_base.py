...
class FarasaBase:
    ...
    __APIs = {
        'segment':shlex.split(f'java -jar {__base_dir}/farasa_bin/lib/FarasaSegmenterJar.jar'),
        'stem' : shlex.split(f'java -jar {__base_dir}/farasa_bin/lib/FarasaSegmenterJar.jar -l true'),
        'NER' : shlex.split(f'java -jar {__base_dir}/farasa_bin/FarasaNERJar.jar'),
        'POS' : shlex.split(f'java -jar {__base_dir}/farasa_bin/FarasaPOSJar.jar'),
        'diacritize' : shlex.split(f'java -jar {__base_dir}/farasa_bin/FarasaDiacritizeJar.jar'),
    }
    __interactive = False
    __task_proc = None
